    ...
    def inputMic(self):
        ...
        with sr.Microphone() as s:
            ...
            try:
                ...
                print(
                    f"Erro ao acessar o serviço de reconhecimento de voz; {e}")
                speech = None
        return speech
    ...
    def Sara(self):
        ...
        while True:
            try:
                ...
                speak('Você deseja sair ? Sim? ou Não?')
                ...
                if (resp_close.lower() in 'sim' or resp_close.lower() in 'Sim'):
                    ...
                    speak('Okay, estou a disposição !')
                    continue
                else:
                    speak('Vou entender como um não')
                    speak('Estou escultando !')
                    continue
